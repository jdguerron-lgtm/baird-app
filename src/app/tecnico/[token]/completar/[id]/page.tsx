  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        {/* 1. Evidencia del servicio (fotos + video opcional). La foto de la
            placa OBLIGATORIA vive solo en el diagnóstico (decisión 2026-08-03:
            repetirla acá era redundante y agregaba fricción al cierre). */}
        <div className="bg-white rounded-xl border border-gray-200 p-4">
