...
-- NOTA: El código usa la columna "especialidad" (no "tipo_electrodomestico")
...
CREATE INDEX IF NOT EXISTS idx_especialidades_tecnico_especialidad
ON especialidades_tecnico(especialidad);

-- Índice para búsqueda por tecnico_id
CREATE INDEX IF NOT EXISTS idx_especialidades_tecnico_tecnico_id
ON especialidades_tecnico(tecnico_id);
