...
| `20260802_repuesto_en_camino_guia.sql` | Estado `repuesto_en_camino` (CHECK 18→19), columnas `guia_envio_*` en `solicitudes_servicio` y `cantidad` en `repuestos_pendientes`. Aplicada vía MCP 2026-08-02 |
